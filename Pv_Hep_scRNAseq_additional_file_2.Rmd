...
# Replicate 1 - Day 5
Hep51a.seu.viv<- AddMetaData(Hep51a.seu.viv, metadata = cell_species.Hep51a$species,
                             col.name = "species")
...
# Replicate 1 - Day 9
Hep91a.seu.viv<- AddMetaData(Hep91a.seu.viv, metadata = cell_species.Hep91a$species,
                             col.name = "species")
...
# Replicate 2 - Day 5
Hep54a.seu.viv<- AddMetaData(Hep54a.seu.viv, metadata = cell_species.Hep54a$species,
                             col.name = "species")
...
# Relicate 2 - Day 9
Hep94a.seu.viv<- AddMetaData(Hep94a.seu.viv, metadata = cell_species.Hep94a$species,
                             col.name = "species")
